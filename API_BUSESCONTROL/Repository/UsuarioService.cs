...
namespace API_BUSESCONTROL.Repository {
    public class UsuarioService : IUsuarioService {
        ...
        public bool RecuperarSenhaMail(Funcionario funcionario) {
            ...
            string urlRecuperacao = $"<a href='http://localhost:4200/redefinirSenha/{funcionario.ChaveRedefinition}'>Clique aqui para recuperar sua conta</a>";
        ...
        public void AlterarSenha(AlterarSenha alterarSenha) {
            ...
            if (Criptografia.GerarHash(alterarSenha.SenhaAtual) != funcionario.Senha) throw new Exception("Senha atual fornecida não corresponde à senha em nossa base de dados!");
